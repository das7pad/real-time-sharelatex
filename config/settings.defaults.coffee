settings =
	redis:
		...
		websessions: 			
			host: process.env['WEB_SESSIONS_REDIS_HOST'] or process.env['REDIS_HOST'] or "localhost"
			port: process.env['WEB_SESSIONS_REDIS_PORT'] or process.env['REDIS_PORT'] or "6379"
			password: process.env["WEB_SESSIONS_REDIS_PASSWORD"] or process.env["REDIS_PASSWORD"] or ""
